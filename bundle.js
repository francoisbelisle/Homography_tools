...
/***/ function(module, exports, __webpack_require__) {
	...
	var _model = __webpack_require__(185);

	_react2['default'].render(_react2['default'].createElement(_componentsApp2['default'], { store: _model.store }), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactImmutableProptypes = __webpack_require__(159);

	var _reactImmutableProptypes2 = _interopRequireDefault(_reactImmutableProptypes);

	var _reactRedux = __webpack_require__(161);

	var _videoFrame = __webpack_require__(179);

	var _videoFrame2 = _interopRequireDefault(_videoFrame);

	var _googleMap = __webpack_require__(183);
	  ...
	  _createClass(_App, [{
	    ...
	    value: function render() {
	      ...
	      if (this.state.imageNaturalSize) {
	        ...
	        imageHeight = this.state.imageNaturalSize.height * imageWidth / this.state.imageNaturalSize.width;
	      }
	      var mapX = gutter + imageWidth;
	      var mapY = 0;
	      var mapWidth = imageWidth;
	      var mapHeight = imageHeight;

	      var mapComponent = false;
	      if (this.state.imageNaturalSize) {
	        mapComponent = _react2['default'].createElement(_googleMap2['default'], {
	          key: 'google-map',
	      ...
	      var detailsComponent = false;
	      if (this.state.imageNaturalSize) {
	        detailsComponent = _react2['default'].createElement(_details2['default'], {
	          key: 'details',
	          dispatch: this.props.dispatch,
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'div',
	          { style: { height: imageHeight + gutter } },
	          _react2['default'].createElement(_videoFrame2['default'], {
	            key: 'video-frame',
	            dispatch: this.props.dispatch,
	            markers: this.props.markers,
	    ...
	    key: 'setImageNaturalSize',
	    value: function setImageNaturalSize(width, height) {
	      this.setState({ imageNaturalSize: { width: width, height: height } });
	    }
	  }, {
	    key: 'setPageWidth',
	    value: function setPageWidth() {
	      this.setState({ pageWidth: document.body.clientWidth });
	    }
	  }, {
	    key: 'handleDownloadButton',
	    value: function handleDownloadButton() {
	      var markers = this.props.markers.zip(this.props.mapMarkers);
	      var lines = markers.map(function (_ref) {
	        var _ref2 = _slicedToArray(_ref, 2);

	        var marker = _ref2[0];
	        var mapMarker = _ref2[1];

	        return marker.x + ' ' + marker.y + ' ' + mapMarker.lat() + ' ' + mapMarker.lng() + '\n';
	      });
	      var payload = encodeURIComponent(lines.join(''));
	...
	_App.propTypes = {
	  ...
	  markers: _reactImmutableProptypes2['default'].listOf(_react2['default'].PropTypes.shape({
	    x: _react2['default'].PropTypes.number,
	    y: _react2['default'].PropTypes.number
	  })).isRequired,
	  mapMarkers: _reactImmutableProptypes2['default'].listOf(_react2['default'].PropTypes.instanceOf(_google2['default'].maps.LatLng)).isRequired
	};
	...
	exports['default'] = (0, _reactRedux.connect)(mapStateToProps)(_App);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _marker = __webpack_require__(181);

	var _marker2 = _interopRequireDefault(_marker);

	var SVG_PADDING_X = 10;
	var SVG_PADDING_Y = 30;
	...
	var VideoFrame = (function (_React$Component) {
	  ...
	  function VideoFrame() {
	    ...
	    _get(Object.getPrototypeOf(VideoFrame.prototype), 'constructor', this).call(this);
	  ...
	  _createClass(VideoFrame, [{
	    ...
	    value: function render() {
	      ...
	      var markers = this.props.markers.map(function (marker, i) {
	        var _fromImageCoords = _this.fromImageCoords(marker.x, marker.y);

	        var x = _fromImageCoords.x;
	        var y = _fromImageCoords.y;

	        return _react2['default'].createElement(_marker2['default'], {
	          key: i, index: i, x: x, y: y,
	          onMarkerMove: _this.handleMarkerMove
	        });
	      });
	      return _react2['default'].createElement(
	        'div',
	    ...
	    key: 'toImageCoords',
	    value: function toImageCoords(x, y) {
	    ...
	    key: 'fromImageCoords',
	    value: function fromImageCoords(x, y) {
	      var zoom = this.getZoom();
	      return {
	    ...
	    key: 'handleImageResize',
	    value: function handleImageResize() {
	      var _this2 = this;
	      ...
	      if (!resizing) {
	        ...
	        window.requestAnimationFrame(function () {
	          var img = _react2['default'].findDOMNode(_this2.refs.img);
	          _this2.setState({
	            imageSize: {
	              width: img.width,
	              height: img.height,
	    ...
	    value: function handleClick(event) {
	      ...
	      var imagePos = this.toImageCoords(x, y);
	      if (imagePos.x >= 0 && imagePos.x < this.state.imageSize.width && imagePos.y >= 0 && imagePos.y < this.state.imageSize.height) {
	        this.props.dispatch((0, _actions.addMarker)(imagePos.x, imagePos.y));
	      }
	    }
	  }, {
	    key: 'handleMarkerMove',
	    value: function handleMarkerMove(index, x, y) {
	      var imagePos = this.toImageCoords(x, y);
	      ...
	      this.props.dispatch((0, _actions.moveMarker)(index, imagePos.x, imagePos.y));
	    }
	  }]);
	...
	VideoFrame.propTypes = {
	  ...
	  dispatch: _react2['default'].PropTypes.func.isRequired,
	  setImageNaturalSize: _react2['default'].PropTypes.func.isRequired,
	  pos: _react2['default'].PropTypes.shape({
	    x: _react2['default'].PropTypes.number,
	    y: _react2['default'].PropTypes.number
	  }).isRequired,
...
/***/ function(module, exports) {
	...
	exports.moveMapMarker = moveMapMarker;
	exports.deleteMapMarker = deleteMapMarker;
	var ADD_MARKER = 'ADD_MARKER';
	exports.ADD_MARKER = ADD_MARKER;
	var MOVE_MARKER = 'MOVE_MARKER';
	exports.MOVE_MARKER = MOVE_MARKER;
	var DELETE_MARKER = 'DELETE_MARKER';
	exports.DELETE_MARKER = DELETE_MARKER;
	var ADD_MAP_MARKER = 'ADD_MAP_MARKER';
	exports.ADD_MAP_MARKER = ADD_MAP_MARKER;
	var MOVE_MAP_MARKER = 'MOVE_MAP_MARKER';
	exports.MOVE_MAP_MARKER = MOVE_MAP_MARKER;
	var DELETE_MAP_MARKER = 'DELETE_MAP_MARKER';

	exports.DELETE_MAP_MARKER = DELETE_MAP_MARKER;
	/* Action creators */

	function addMarker(x, y) {
	  return { type: ADD_MARKER, x: x, y: y };
	}

	function moveMarker(index, x, y) {
	  return { type: MOVE_MARKER, index: index, x: x, y: y };
	}

	function deleteMarker(index) {
	  return { type: DELETE_MARKER, index: index };
	}

	function addMapMarker(latLng) {
	  return { type: ADD_MAP_MARKER, latLng: latLng };
	}

	function moveMapMarker(index, latLng) {
	  return { type: MOVE_MAP_MARKER, index: index, latLng: latLng };
	}

	function deleteMapMarker(index) {
	  return { type: DELETE_MAP_MARKER, index: index };
	}
...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  _createClass(Marker, [{
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement('path', { d: _utils.PIN_SVG_PATH, fill: 'cyan' }),
	        _react2['default'].createElement(
	          'text',
	          { textAnchor: 'middle', fontSize: '14', y: '-15' },
	          (0, _utils.markerLabel)(this.props.index)
	        )
	      );
	    }
	  }, {
	    ...
	    value: function handleMouseDown(event) {
	      ...
	      var offsetX = this.props.x - event.clientX;
	      var offsetY = this.props.y - event.clientY;

	      var dragHandler = function dragHandler(dragEvent) {
	        _this.props.onMarkerMove(_this.props.index, dragEvent.clientX + offsetX, dragEvent.clientY + offsetY);
	      };
	...
	Marker.propTypes = {
	  ...
	  x: _react2['default'].PropTypes.number,
	  y: _react2['default'].PropTypes.number,
	  onMarkerMove: _react2['default'].PropTypes.func
	};
...
/***/ function(module, exports) {
	...
	var PIN_SVG_PATH = ['M 0 0', 'C 0 -5 -10 -15 -10 -20', 'S -5 -30 0 -30', 'S 10 -25 10 -20', 'S 0 -5 0 0'].join(' ');
	exports.PIN_SVG_PATH = PIN_SVG_PATH;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GoogleMap = (function (_React$Component) {
	  ...
	  _createClass(GoogleMap, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      var node = _react2['default'].findDOMNode(this.refs.map);
	      this.map = new _google2['default'].maps.Map(node, {
	        center: { lat: 45.53, lng: -73.65 },
	        zoom: 11,
	        streetViewControl: false,
	        mapTypeId: _google2['default'].maps.MapTypeId.SATELLITE
	      });
	      _google2['default'].maps.event.addListener(this.map, 'click', function (event) {
	        _this.props.dispatch((0, _actions.addMapMarker)(event.latLng));
	      });
	      this.updateMarkers();
	    }
	  }, {
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement('div', { className: 'map', ref: 'map', style: mapStyle });
	    }
	  }, {
	    key: 'updateMarkers',
	    value: function updateMarkers() {
	      ...
	      var loopend = Math.max(this.props.markers.size, this.markers.length);

	      var _loop = function (i) {
	        var latLng = _this2.props.markers.get(i);
	        var uiMarker = _this2.markers[i];
	        if (uiMarker && latLng) {
	          uiMarker.setPosition(latLng);
	        } else if (uiMarker && !latLng) {
	          uiMarker.setMap(null);
	          _google2['default'].maps.event.removeListener(_this2.listeners[i]);
	          delete _this2.markers[i];
	          delete _this2.listeners[i];
	        } else if (!uiMarker && latLng) {
	          uiMarker = _this2.markers[i] = new _google2['default'].maps.Marker({
	            label: (0, _utils.markerLabel)(i),
	            map: _this2.map,
	            position: latLng,
	            draggable: true,
	            icon: {
	              path: _utils.PIN_SVG_PATH,
	              fillColor: 'cyan',
	              fillOpacity: 1.0,
	              strokeOpacity: 0.0,
	              labelOrigin: new _google2['default'].maps.Point(0, -20)
	            }
	          });
	          _this2.listeners[i] = uiMarker.addListener('dragend', function (event) {
	            return _this2.handleMarkerDrag(event, i);
	          });
	        }
	      };
	    ...
	    key: 'handleMarkerDrag',
	    value: function handleMarkerDrag(event, index) {
	      this.props.dispatch((0, _actions.moveMapMarker)(index, event.latLng));
	    }
	  }]);
	...
	GoogleMap.propTypes = {
	  ...
	  markers: _reactImmutableProptypes2['default'].listOf(_react2['default'].PropTypes.instanceOf(_google2['default'].maps.LatLng)).isRequired
	};
	...
	var Details = (function (_React$Component) {
	  ...
	  _createClass(Details, [{
	    ...
	    value: function render() {
	      ...
	      var mapMarkers = this.props.mapMarkers;
	      var nMarkers = Math.max(markers.size, mapMarkers.size);
	      var rows = [];

	      var _loop = function (i) {
	        var marker = markers.get(i);
	        var mapMarker = mapMarkers.get(i);
	        var markerX = '';
	        var markerY = '';
	        var mapMarkerLat = '';
	        var mapMarkerLng = '';
	    ...
	    key: 'deleteMarker',
	    value: function deleteMarker(index) {
	      this.props.dispatch((0, _actions.deleteMarker)(index));
	      this.props.dispatch((0, _actions.deleteMapMarker)(index));
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var emptyList = _immutable.List.of();

	function markers(state, action) {
	  if (state === undefined) state = emptyList;
	...
	function mapMarkers(state, action) {
	  if (state === undefined) state = emptyList;
	...
	var app = (0, _redux.combineReducers)({ markers: markers, mapMarkers: mapMarkers });
